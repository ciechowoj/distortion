...
def show_frames(frames, threshold, env_mask, cell_size, nframe, ftime):
    ...
    result = [nframe, ftime] + [-1, -1] * len(frames)
...
streams = [
    ...
    ("data/notebook.mp4",  14521, 24.834,       240, 0),
    ("data/P8 Lite.mp4",   9513,  29.739420,    243, 1.0),
    ("data/620.mp4",       11998, 30.000,       235, 0.25),
